            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        row.append('<div class="col-xs-9"><h4 class="list-group-item-heading">' + result[i].first_name + ' ' + result[i].last_name + '</h4><p class="list-group-item-text">Lorem ipsum dolor</p></div>');
